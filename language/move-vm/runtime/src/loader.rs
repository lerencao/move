...
impl Loader {
    ...
    pub fn load_type(&self, type_tag: &TypeTag, data_store: &impl DataStore) -> VMResult<Type> {
        Ok(match type_tag {
    ...
    pub fn load_module(&self, id: &ModuleId, data_store: &impl DataStore) -> VMResult<Arc<Module>> {
